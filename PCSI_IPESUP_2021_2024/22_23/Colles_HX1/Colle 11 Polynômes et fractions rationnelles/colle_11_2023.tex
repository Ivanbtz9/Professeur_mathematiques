...
\begin{document}
	...
	\begin{center}
		\Large \sc colle 11 = Polynômes et fractions rationnelles
	\end{center}
\raggedright

\section*{Connaître son cours:}
\begin{enumerate}
	\item Soit $P \in \K_n [X ]$ et $ a \in \K$. Montrer que $P (X ) =  \mathlarger{\mathlarger{\sum}}\limits_{k=0}^{n}\dfrac{P^{(k)}(a)}{k!}(X-a)^k$. En déduire qu'une racine $a$ de $P$ est de multiplicité $r$ si, et seulement si, $P^{(k)} (a) = 0$ pour tout $k \leq r - 1$ et $P^{(r)}(a) \neq0$.
...
\begin{exo}\textbf{(**)}\quad\\[0.25cm]
Factoriser la fraction rationnelle dont la décomposition en éléments simples est:
$$\displaystyle \mathlarger\sum\limits_{\omega\in\mathbb U_n }\dfrac{\omega^3}{X-\omega}$$	
...
\begin{exo}\textbf{(***)}\quad\\[0.25cm]
Trouver tous les polynômes $P\in\C[X]$ tels que $P\left(\mathbb{U}\right) \subset \mathbb{U}$.
...
\begin{exo}\textbf{(*)}\quad\\[0.25cm]
				\begin{enumerate}
		\item Décomposer en éléments simples la fraction rationnelle $\displaystyle\frac{1}{X(X+1)(X-1)}$.
		\item En déduire la limite de la suite $(S_n)_{n\geq 2}$ suivante : $\displaystyle S_n=\sum_{k=2}^n \frac{1}{k(k+1)(k-1)}$.
	\end{enumerate}
